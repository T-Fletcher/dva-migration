...
abstract class MigrateMediaTestBase extends MigrateUpgradeTestBase {
  ...
  protected function getExpectedEntities() {
    ...
    // Drupal core 8.7 has 'file' media bundle, while Drupal core 8.8+ has
    // 'document'.
    if (version_compare(\Drupal::VERSION, '8.8', '<')) {
      unset($expected_entities['media_type']['document']);
      unset($expected_entities['entity_form_display']['media.document.default']);
      unset($expected_entities['entity_view_display']['media.document.default']);
      unset($expected_entities['field_config']['media.document.field_media_document']);
      unset($expected_entities['field_storage_config']['media.field_media_document']);
      $expected_entities['media_type']['file'] = 'File';
      $expected_entities['entity_form_display']['media.file.default'] = NULL;
      $expected_entities['entity_view_display']['media.file.default'] = NULL;
      $expected_entities['field_config']['media.file.field_media_file'] = 'File';
      $expected_entities['field_storage_config']['media.field_media_file'] = 'media.field_media_file';
    }
